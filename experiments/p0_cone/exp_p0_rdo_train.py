...
def main():
    ...
    # Directory layout (all paths relative to model_dir):
    #   dim/          ← DIM cone files, metadata, directions/, selection/
    #   rdo/          ← RDO cone files, training logs, responses
    #   rdo/targets/  ← training targets (from exp_p0_rdo_targets.py)
    targets_dir = os.path.join(model_dir, "rdo", "targets")
    rdo_dir = os.path.join(model_dir, "rdo")
