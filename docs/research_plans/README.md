...
6. **`2026-07-01/Evo-CaRoB_轻量自进化定位与挂载实验方案_20260701.md`** — 在不改变 CaRoB 主线的前提下，加入轻量自进化配置搜索，重点自动优化 MoE 层定位与 LoRA/bridge 挂载层。

## 日期归档

- **`2026-07-01/`** — 2026-07-01 当天新增/推送的实验方案归档。后续同一天形成的方案文档也放入该目录，避免根目录继续膨胀。
